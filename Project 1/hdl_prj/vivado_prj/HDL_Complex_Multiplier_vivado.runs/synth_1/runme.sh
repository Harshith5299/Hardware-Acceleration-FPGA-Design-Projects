...
HD_PWD='C:/hdl_prj/vivado_prj/HDL_Complex_Multiplier_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDL_Complex_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDL_Complex_Multiplier.tcl
