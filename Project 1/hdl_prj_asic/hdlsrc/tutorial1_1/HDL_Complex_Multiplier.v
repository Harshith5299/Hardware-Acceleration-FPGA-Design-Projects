// -------------------------------------------------------------
// 
// File Name: hdl_prj_asic/hdlsrc/tutorial1_1/HDL_Complex_Multiplier.v
// Created: 2021-02-02 16:34:14
// 
...
module HDL_Complex_Multiplier
  ...
  reg signed [23:0] Delay7_out1;  // sfix24_En16
  wire signed [23:0] Product_out1;  // sfix24_En16
  reg signed [23:0] Delay6_out1;  // sfix24_En16
  ...
  reg signed [23:0] Delay3_out1;  // sfix24_En16
  wire signed [23:0] Product3_out1;  // sfix24_En16
  reg signed [23:0] Delay4_out1;  // sfix24_En16
  ...
  assign Product1_out1 = Delay_out1_re * Delay1_out1_re;
  ...
  always @(posedge clk)
    begin : Delay7_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          Delay7_out1 <= Product1_out1;
        end
      end
    end


  assign Product_out1 = Delay_out1_im * Delay1_out1_im;
  ...
  assign Add_sub_cast = {Delay7_out1[23], Delay7_out1};
  assign Add_sub_cast_1 = {Delay6_out1[23], Delay6_out1};
  ...
  assign Product2_out1 = Delay_out1_re * Delay1_out1_im;
  ...
  assign Product3_out1 = Delay1_out1_re * Delay_out1_im;
  ...
  assign Add1_add_cast = {Delay3_out1[23], Delay3_out1};
  assign Add1_add_cast_1 = {Delay4_out1[23], Delay4_out1};
